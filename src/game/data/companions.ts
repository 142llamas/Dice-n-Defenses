...
export const COMPANIONS: CompanionDefinition[] = [
...

  {
    ...
    build: {
      ...
      backgroundAbilityChoice: { str: 2, con: 1 },
      classId: "fighter",
      level: 1,
  ...
  },
  {
    ...
    build: {
      ...
      name: "Fenna Duskwater",
      raceId: "half-elf",
      backgroundId: "harborhand",
      backgroundAbilityChoice: { con: 2, str: 1 },
      classId: "druid",
      level: 1,
  ...
  },
  {
    ...
    build: {
      ...
      raceId: "elf",
      backgroundId: "sage",
      backgroundAbilityChoice: { int: 2, wis: 1 },
      classId: "wizard",
      level: 1,
  ...
  },
  {
    ...
    build: {
      ...
      name: "Sorrel Thane",
      raceId: "goliath",
      // D-206: thematically deliberate — Sorrel's own fate arc (D-185) IS
      // the Unremembering claiming someone in real time; Ember-Marked's
      // whole concept is a person watching that same erosion happen to
      // themselves.
      backgroundId: "ember-marked",
      backgroundAbilityChoice: { dex: 2, wis: 1 },
      classId: "ranger",
      level: 1,
  ...
  },
  {
    ...
    build: {
      ...
      raceId: "gnome",
      backgroundId: "criminal",
      backgroundAbilityChoice: { dex: 2, con: 1 },
      classId: "bard",
      level: 1,
  ...
  },
  {
    ...
    build: {
      ...
      name: "Perrin Holt",
      raceId: "human",
      backgroundId: "hedge-warden",
      backgroundAbilityChoice: { wis: 2, cha: 1 },
      classId: "cleric",
      level: 1,
  ...
  },
  {
    ...
    build: {
      ...
      backgroundAbilityChoice: { wis: 2, int: 1 },
      classId: "monk",
      level: 1,
      abilityScores: new StandardArrayAllocator(["dex", "wis", "con", "str", "cha", "int"]).scores(),
      controlledBy: "ai",
  ...
  },
  {
    ...
    build: {
      ...
      raceId: "orc",
      backgroundId: "criminal",
      backgroundAbilityChoice: { dex: 2, int: 1 },
      classId: "rogue",
      level: 1,
  ...
  },
  {
    ...
    build: {
      ...
      name: "Ellery Vance",
      raceId: "dragonborn",
      backgroundId: "ledger-keeper",
      backgroundAbilityChoice: { cha: 2, int: 1 },
      classId: "sorcerer",
      level: 1,
      abilityScores: new StandardArrayAllocator(["cha", "con", "dex", "wis", "int", "str"]).scores(),
      controlledBy: "ai",
